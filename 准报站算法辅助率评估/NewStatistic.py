...
def outputDetail(sample_file, cmp_file):
    outputBuses(sample_file, NoDetectBusSet | WrongBusSet | MissAfterBusSet | DirWrongBusSet | OnlineWrongBusSet, os.path.join(file_dir,'total.csv'))
    ...
    outputBuses(cmp_file, NoDetectBusSet | WrongBusSet | MissAfterBusSet | DirWrongBusSet | OnlineWrongBusSet, os.path.join(file_dir,'sorted.cmp'), 1)
...
def Report():
    global NoDetectBusSet, WrongBusSet, MissAfterBusSet, DirWrongBusSet, OnlineWrongBusSet
